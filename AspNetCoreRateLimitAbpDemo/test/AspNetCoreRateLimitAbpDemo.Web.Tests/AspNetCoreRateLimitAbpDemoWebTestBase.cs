...
{
    public abstract class AspNetCoreRateLimitAbpDemoWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static AspNetCoreRateLimitAbpDemoWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(AspNetCoreRateLimitAbpDemoWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<AspNetCoreRateLimitAbpDemoDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<AspNetCoreRateLimitAbpDemoDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<AspNetCoreRateLimitAbpDemoDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<AspNetCoreRateLimitAbpDemoDbContext, Task<T>> func)
        {
            T result;
