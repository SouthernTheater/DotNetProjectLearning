...
namespace AspNetCoreRateLimitAbpDemo.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        public TenantRoleAndUserBuilder(AspNetCoreRateLimitAbpDemoDbContext context, int tenantId)
        {
            _context = context;
            _tenantId = tenantId;
        }
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new AspNetCoreRateLimitAbpDemoAuthorizationProvider())
