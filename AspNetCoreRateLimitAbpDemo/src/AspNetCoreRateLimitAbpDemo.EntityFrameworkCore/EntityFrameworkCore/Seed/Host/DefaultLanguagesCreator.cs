...
namespace AspNetCoreRateLimitAbpDemo.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AspNetCoreRateLimitAbpDemoConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(AspNetCoreRateLimitAbpDemoDbContext context)
        {
            _context = context;
        }
